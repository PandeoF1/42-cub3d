...
#    Updated: 2022/04/07 10:13:22 by asaffroy         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
CC			= gcc
CC_FLAGS	= -O3 -Ofast -flto -march=native -ffast-math -Wall -Werror -Wextra #-fsanitize=address -g3 #-Wall -Werror -Wextra -g3  
